...
public class VeterinariaDbHelper extends SQLiteOpenHelper {
    // If you change the database schema, you must increment the database version.
    public static final int DATABASE_VERSION = 1;
    public static final String DATABASE_NAME = "Veterinaria.db";

    public VeterinariaDbHelper(Context context) {
    ...
    private static final String SQL_CREATE_ENTRIES =
            "CREATE TABLE " + VeterinariaContract.UsuarioEntry.TABLE_NAME + " (" +
                    VeterinariaContract.UsuarioEntry._ID + " INTEGER PRIMARY KEY," +
